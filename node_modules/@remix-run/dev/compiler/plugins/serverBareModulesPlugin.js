  ...
  return {
    ...
    setup(build) {
      build.onResolve({
        ...
        if (onWarning && !isNodeBuiltIn(packageName) && (!remixConfig.serverBuildTarget || remixConfig.serverBuildTarget === "node-cjs")) {
  ...
  try {
    ...
    if (pkg.type === "module") {
      ...
      if (pkg.exports) {
        ...
        } else if ((_pkg$exports$2 = pkg.exports[`./${subImport}`]) !== null && _pkg$exports$2 !== void 0 && _pkg$exports$2.require) {
          isEsmOnly = false;
        }
      }
